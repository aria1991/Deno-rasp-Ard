...
RUN [ "$TARGETPLATFORM" == "linux/arm64" ] && curl -Lsf https://github.com/supabase/deno-arm64/releases/download/${VERSION}/deno-$(echo $TARGETPLATFORM | tr '/' '-').zip -o deno.zip || true
